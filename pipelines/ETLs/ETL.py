...
from ETLs.ops import featurize, parse
from ETLs.ops.parse import partition_keys, partitions
from utils.configs import DatabaseResource, ParserResource, S3Resource
...
defs = Definitions(assets=parse_assets + featurize_assets,
                   ...
                   resources={
                       "db":
                       DatabaseResource(connection_path='../data/protodb.db'),
